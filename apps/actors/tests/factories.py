...
from apps.actors.models import NATIONALITY_CHOICES, Actor
...
class ActorFactory(factory.django.DjangoModelFactory):
    ...
    birthday = factory.LazyAttribute(lambda birthday: faker_gen.date_of_birth(minimum_age=18, maximum_age=99))
